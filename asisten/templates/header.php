...
<div class="flex h-screen bg-gray-100">
    <aside class="w-64 bg-purple-900 text-white flex flex-col" style="height: 100vh; position: fixed;">
        <div class="p-6 text-center border-b border-purple-800">
            <h3 class="text-xl font-bold">Panel Asisten</h3>
            <p class="text-sm text-purple-300 mt-1"><?php echo htmlspecialchars($_SESSION['nama']); ?></p>
        </div>
        <nav class="flex-grow">
            <ul class="space-y-2 p-4">
                <?php 
                    $activeClass = 'bg-purple-800 text-white';
                    $inactiveClass = 'text-purple-300 hover:bg-purple-700 hover:text-white';
                ?>
                <li>
        ...
        <div class="p-4 mt-auto border-t border-purple-800">
             <a href="../logout.php" class="flex items-center justify-center bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-300 w-full">
