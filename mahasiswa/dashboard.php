...
<div class="bg-gradient-to-r from-purple-800 to-purple-600 text-white p-8 rounded-xl shadow-lg mb-8">
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
    <div class="bg-white shadow-md p-6 rounded-xl text-center hover:shadow-lg transition">
        <div class="text-purple-800 text-4xl font-extrabold"><?php echo $total_praktikum; ?></div>
        <p class="mt-2 text-gray-600">Praktikum Diikuti</p>
    </div>
    <div class="bg-white shadow-md p-6 rounded-xl text-center hover:shadow-lg transition">
        <div class="text-purple-700 text-4xl font-extrabold"><?php echo $total_selesai; ?></div>
...
<div class="bg-white shadow-md p-6 rounded-xl">
    <h2 class="text-2xl font-bold mb-4 text-purple-900">🔔 Notifikasi Terbaru</h2>
    <ul class="space-y-4">
            ...
            <?php while($notif = $notifikasi_list->fetch_assoc()): ?>
                <li class="border-b pb-3 last:border-b-0">
                    <div class="text-gray-700">
                        Nilai untuk <a href="detail_praktikum.php?id=<?php echo $notif['praktikum_id']; ?>" class="text-purple-700 font-semibold hover:underline">
